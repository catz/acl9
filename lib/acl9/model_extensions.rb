  ...
  module ModelExtensions  #:nodoc:
    ...
    module ClassMethods
      ...
      def acts_as_authorization_subject(options = {})
        ...
        has_many :assignments, :class_name => join_table.classify

        has_many assoc, :class_name => role, :through => :assignments,
          :source => role.demodulize.tableize.singularize.to_sym
      ...
      def acts_as_authorization_role(options = {})
        ...
        has_many :assignments, :class_name => join_table.classify
        has_many subject.demodulize.tableize.to_sym, :class_name => subject, :through => :assignments,
          :source => subject.demodulize.tableize.singularize.to_sym
