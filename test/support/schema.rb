ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "another_roles_another_subjects", :force => true do |t|
  ...
  create_table "different_association_name_roles_different_association_name_subjects", :force => true do |t|
  ...
  create_table "other_roles_other_users", :force => true do |t|
    t.integer  "user_id"
    t.integer  "role_id"
    t.datetime "created_at"
    t.datetime "updated_at"
